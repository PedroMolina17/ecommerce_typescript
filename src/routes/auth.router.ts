...
import { checkAuthAdmin, loginAdmin, logoutAdmin, registerAdmin } from "../controllers/admin/auth/auth.ctrl";
...
router.get("/check-admin",verifyJwt,verifyAuthRole([ROLE.ADMIN]),checkAuthAdmin)
