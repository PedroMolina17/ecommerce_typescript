...
import { getNotifications, markAllNotificationRead, markNotificationReadById } from "../controllers/admin/notification.ctrl";
...
router.put("/mark-all-as-read", verifyJwt,verifyAuthRole([ROLE.ADMIN]), markAllNotificationRead);
